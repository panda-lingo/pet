...
/**
 * jsdom shims for Solution A's tests.
 *
 ...
 *
 * The Web Animations API is deliberately *not* shimmed: the renderer must degrade gracefully
 * where `Element.animate` is missing, and these tests prove that it does.
 */
