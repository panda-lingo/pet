 ...
 *
 * These tests run in the reduced-motion profile on purpose — travel time is then 0ms, so the
 * assertions are about the state machine rather than about waiting for a walk to finish.
 */
